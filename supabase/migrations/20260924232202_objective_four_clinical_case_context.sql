-- Objective 4. Prepare an auditable clinical case when an alert is created.
-- This migration stores the snapshot consumed by the future AI support flow.
-- It does not generate recommendations or expose service-role data to the UI.
begin;
