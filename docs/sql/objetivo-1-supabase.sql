-- TrackyGlu | Base de datos — objetivo 1 (instalación nueva)
--
-- Para usar: Supabase Dashboard → SQL Editor → New query, pegar TODO este archivo y ejecutar.
-- Destino: un proyecto Supabase VACÍO que no tenga la tabla public.glucose_readings ni datos clínicos.
-- El script combina en orden las migraciones 001 y 20260924052426 del repositorio.
-- La misma migración está en supabase/migrations/ para instalaciones locales mediante Supabase CLI.
--
-- No está diseñado para actualizar una instancia que ya tenga datos o tablas: antes hay que conciliar
-- sus UUID de pacientes/lecturas y el esquema real. Revisar docs/architecture/access-profiles.md.
-- Este archivo SQL es una copia para pegar; al modificar una migración, volver a sincronizarlo y probarlo
-- completo contra una base nueva en Docker antes de publicarlo.

-- ===== Migración 001_create_glucose_readings.sql =====
...
-- ===== Migración 20260924052426_objective_one_access_profiles.sql =====
